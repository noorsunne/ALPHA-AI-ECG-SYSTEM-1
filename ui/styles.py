...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .login-sub { text-align:center; font-size:13px; color:#64748b; margin-bottom:24px; }
  .demo-creds {
  ...
  .feedback-meta { font-size:10px; color:#475569; margin-bottom:4px; font-family:monospace; }
</style>
